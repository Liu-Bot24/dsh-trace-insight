...
For the current version, use the [standard patch-free sidebar 1.6.4](packages/standard/README.en.md). The root installation and removal scripts belong to the legacy file-patched edition; its usage and restoration instructions remain below.
