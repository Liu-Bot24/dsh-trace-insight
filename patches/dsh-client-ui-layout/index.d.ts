...
declare module '@deepseek-ai/dsh-client-ui-slots' {
    interface SlotMap {
        ...
        /**
         * The inspector pane of the shared right rail: a session-scoped sidekick
         * surface (e.g. a trajectory interpreter) that shares the resizable right
         * column with the tool-details pane. Both panes stay mounted while the
         * rail is closed (width 0), and the rail is open whenever either pane is.
         * Unoccupied, the rail simply never opens for it.
         */
        'inspector': {
            kind: 'single';
            scope: 'session';
